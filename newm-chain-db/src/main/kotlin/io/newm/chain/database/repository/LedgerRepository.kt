...
interface LedgerRepository {
    ...
    fun queryLedgerAssetMetadataListByNativeAsset(name: String, policy: String): List<LedgerAssetMetadata>
    ...
    fun queryUtxoByNativeAsset(name: String, policy: String): Utxo?
