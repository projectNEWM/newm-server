...
class KeysRepositoryImpl : KeysRepository {
    ...
    override fun get(id: Long): Key? = keyCache[id]
    ...
    override fun findByAddress(address: String): Key? = addressKeyCache[address]

    override fun findByScriptAddress(scriptAddress: String): Key? = transaction {
    ...
    override fun findByTxId(transactionId: String): List<Key> = transaction {
    ...
    override fun insert(key: Key): Long {
        return transaction {
     ...
     */
    override fun updateScriptAndScriptAddress(key: Key): Int {
        return transaction {
