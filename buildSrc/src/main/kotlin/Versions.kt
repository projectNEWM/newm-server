object Versions {
    const val APACHE_COMMONS_CODEC = "1.17.2"
    ...
    const val SENTRY = "7.20.0"
    const val SHADOW_PLUGIN = "8.1.1"
    const val SPRING_SECURITY = "6.4.2"
    const val SSL_KICKSTART = "9.0.0"
    const val SWAGGER = "1.0.55"
    const val TEST_CONTAINERS = "1.20.4"
