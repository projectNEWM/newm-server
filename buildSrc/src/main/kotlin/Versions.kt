object Versions {
    ...
    const val APACHE_CURATORS = "5.7.0"
    const val APACHE_TIKA = "2.9.2"
    const val ARWEAVE4S = "0.21.0"
    const val AWS = "2.28.16"
    ...
    const val KOTLIN_PLUGIN = "2.0.20"
    ...
    const val SWAGGER = "1.0.52"
    const val TEST_CONTAINERS = "1.20.2"
