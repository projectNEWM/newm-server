...
internal class MintingStatusHistoryRepositoryImpl : MintingStatusHistoryRepository {
    ...
    override suspend fun add(mintingStatusHistory: MintingStatusTransactionEntity) =
        transaction {
            MintingStatusTransactionEntity
                .new {
                    mintingStatus = mintingStatusHistory.mintingStatus
                    timestamp = mintingStatusHistory.timestamp
                    logMessage = mintingStatusHistory.logMessage
                }.id.value
        }
