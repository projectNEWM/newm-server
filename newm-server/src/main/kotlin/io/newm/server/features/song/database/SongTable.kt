...
object SongTable : UUIDTable(name = "songs") {
    ...
    val genres: Column<List<String>> = textArray("genres")
    val moods: Column<List<String>?> = textArray("moods").nullable()
    ...
    val ipis: Column<List<String>?> = textArray("ipis").nullable()
