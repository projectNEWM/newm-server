...
class UserRoutesTests : BaseApplicationTests() {
    ...
    @Test
    fun testPostUserWhitelistFailure() =
        runBlocking {
    ...
    @Test
    fun testPostUserWhitelistSuccess() =
        runBlocking {
            val startTime = LocalDateTime.now()
    ...
    @Test
    fun testGetAllUsersInDescendingOrder() =
        runBlocking {
            // Put Users directly into database
