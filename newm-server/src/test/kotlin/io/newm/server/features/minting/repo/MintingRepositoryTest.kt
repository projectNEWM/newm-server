...
class MintingRepositoryTest : BaseApplicationTests() {
    ...
    fun `buildStreamTokenMetadata test`(): Unit = runBlocking {
        ...
        assertThat(plutusDataHex).isEqualTo(
            ""
        )
    }
    ...
    fun `test calculateTokenNames`() {
        ...
        val (refTokenName, fracTokenName) = mintingRepository.calculateTokenNames(
            utxo {
    ...
    @Test
    @Disabled
    fun `test buildMintingTransaction`(): Unit = runBlocking {
        setupDatabase()
        ...
        val cashRegisterKey = Key.createFromCliKeys(
            CliKeyPair(
                "newm",
                vkey = CliKey(
                    type = "PaymentVerificationKeyShelley_ed25519",
        ...
        val collateralKey = Key.createFromCliKeys(
            CliKeyPair(
                "collateral",
                vkey = CliKey(
                    type = "PaymentVerificationKeyShelley_ed25519",
        ...
        var response = mintingRepository.buildMintingTransaction(
            paymentUtxo = utxo {
        ...
        response = mintingRepository.buildMintingTransaction(
            paymentUtxo = utxo {
                hash = "8ca645eee53117971504b47712f86105ce84f9d8ebc2985ea7ce0a815846a603"
                ix = 0L
                lovelace = "10000000"
