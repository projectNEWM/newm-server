...
val testUser1 = User(
    ...
    spotifyProfile = "SpotifyProfile1",
    soundCloudProfile = "SoundCloudProfile1",
    appleMusicProfile = "AppleMusicProfile1",
    location = "Location1",
    role = "Role1",
    genre = "Genre1",
...
val testUser2 = User(
    ...
    spotifyProfile = "SpotifyProfile2",
    soundCloudProfile = "SoundCloudProfile2",
    appleMusicProfile = "AppleMusicProfile2",
    location = "Location2",
    role = "Role2",
    genre = "Genre2",
