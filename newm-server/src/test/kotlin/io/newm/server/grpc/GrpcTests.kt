...
//        private const val TEST_SECURE = true
    ...
    fun `test queryUtxos`() =
        runBlocking {
            ...
            assertThat(
                ...
                "d8799f581c602a7e54f9c569c770ba6f732af3077d8b06e14b84abc8d0151635d8581c3ab25c853f0f188f43b34b2df5cb98737a4de7e19028ec9d1a414a55464e45574d5f31581c9bb822cdf2c6c79657c0e8ec24308487dbd35750c084e271620d9d8040ff"
            )
    ...
    @Test
    @Disabled
    fun `test queryUtxosByStakeAddress`() =
        runBlocking {
            val client = buildClient()
            val request =
                queryUtxosRequest {
    ...
    @Test
    @Disabled
    fun `test queryUtxosByOutputRef`() =
        runBlocking {
            val client = buildClient()
            val request =
        ...
        runBlocking {
            ...
            val request =
                submitTransactionRequest {
                    cbor =
                        ByteString.fromHex(
                            ""
                        )
                }
    ...
    @Test
    @Disabled
    fun `test queryLiveUtxos`() =
        runBlocking {
            val client = buildClient()
            val queryUtxosRequest =
                queryUtxosRequest {
            ...
            val request =
                submitTransactionRequest {
                    cbor =
                        ByteString.fromHex(
                            ""
                        )
                }
    ...
    @Test
    @Disabled
    fun `test queryTransactionConfirmations`() =
        runBlocking {
            val client = buildClient()
            val request =
                queryTransactionConfirmationCountRequest {
                    with(txIds) {
            ...
            assertThat(
                response.txIdToConfirmationCountMap["a8ebbe98a73d733dd1664fddab025582900bf9bf64b1999128e53534a864ea24"]
            ).isGreaterThan(
    ...
    @Test
    @Disabled
    fun `test monitorPaymentAddress`() =
        runBlocking {
            val client = buildClient()
            val response =
                client.monitorPaymentAddress(
    ...
    @Test
    @Disabled
    fun `test monitorPaymentAddress ada-only`() =
        runBlocking {
            val client = buildClient()
            val response =
                client.monitorPaymentAddress(
    ...
    @Test
    @Disabled
    fun `test monitorNativeAssets`() =
        runBlocking {
            val client = buildClient()
            val flow =
                client.monitorNativeAssets(
    ...
    @Test
    @Disabled
    fun `test calculateMinUtxoForOutput`() =
        runBlocking {
            val client = buildClient()
            val request =
                outputUtxo {
    ...
    @Test
    @Disabled
    fun `test queryWalletControlledLiveUtxos`() =
        runBlocking {
            val client = buildClient()
            val request =
                walletRequest {
    ...
    @Test
    @Disabled
    fun `test queryUtxoByNativeAsset`() =
        runBlocking {
            val client = buildClient()
            val request =
