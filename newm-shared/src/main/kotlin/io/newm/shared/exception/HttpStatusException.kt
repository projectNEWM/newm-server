    ...
    companion object {
        fun HttpStatusCode.toException(message: String): HttpStatusException =
            when (this) {
                ...
                HttpStatusCode.NotFound -> HttpNotFoundException(message)
                HttpStatusCode.Forbidden -> HttpForbiddenException(message)
                HttpStatusCode.UnprocessableEntity -> HttpUnprocessableEntityException(message)
                HttpStatusCode.Conflict -> HttpConflictException(message)
