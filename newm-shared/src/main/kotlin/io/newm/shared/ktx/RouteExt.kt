...
inline fun Route.get(path: String, crossinline body: suspend ApplicationCall.() -> Unit) = get(path) { body(call) }

inline fun Route.get(crossinline body: suspend ApplicationCall.() -> Unit) = get { body(call) }

inline fun Route.put(path: String, crossinline body: suspend ApplicationCall.() -> Unit) = put(path) { body(call) }

inline fun Route.put(crossinline body: suspend ApplicationCall.() -> Unit) = put { body(call) }

inline fun Route.post(path: String, crossinline body: suspend ApplicationCall.() -> Unit) = post(path) { body(call) }
...
inline fun Route.delete(path: String, crossinline body: suspend ApplicationCall.() -> Unit) =
    delete(path) { body(call) }

inline fun Route.delete(crossinline body: suspend ApplicationCall.() -> Unit) = delete { body(call) }

inline fun Route.head(path: String, crossinline body: suspend ApplicationCall.() -> Unit) = head(path) { body(call) }

inline fun Route.head(crossinline body: suspend ApplicationCall.() -> Unit) = head { body(call) }

inline fun Route.options(path: String, crossinline body: suspend ApplicationCall.() -> Unit) =
